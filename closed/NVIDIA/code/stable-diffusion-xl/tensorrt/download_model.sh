...
if [ ! -d "${MODEL_DIR}/SDXL/official_pytorch/fp16" ]; then
    echo "Directory not found, proceeding with download and verification..."
    ...
    echo "Directory ${MODEL_DIR}/SDXL/official_pytorch/fp16 already exists. Skipping download and verification."
fi
